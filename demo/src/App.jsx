...
function App() {
    ...
    if (q) {
      filtered = products.filter(
        (p) =>
          ...
          p.des?.toLowerCase().includes(q)   // ✅ changed
      );
    }
  ...
  // Reset form
  const resetForm = () => {
    setForm({ id: "", name: "", des: "", price: "", quantity: "" });  // ✅ changed
    setEditId(null);
  };
                  ...
                  <tbody>
                    {filteredProducts.map((p) => (
                      <tr key={p.id}>
                        ...
                        <td className="desc-cell" title={p.des}>
                          {p.des}
                        </td>
